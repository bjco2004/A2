...
public class Sender {
   ...
   public static void main(String[] args) throws Exception {
       ...
       if (!gbn) {
           ...
           // ========================================================================
           // Send one packet at a time and wait for its specific ACK before proceeding
           // Simple but slow: throughput = 1 / (2 * RTT + transmission_time)
           // Reliable: retransmits on timeout until successful
           // ========================================================================
           ...
           // ========================================================================
           // Pipelined transmission with sliding window of size N
           // Can send up to N packets before waiting for ACK
           // Receives cumulative ACKs: single ACK acknowledges all packets up to that seq
           // On timeout: retransmit entire window from unacked base
           // Throughput scales with window size (better than Stop-and-Wait)
           // ========================================================================
